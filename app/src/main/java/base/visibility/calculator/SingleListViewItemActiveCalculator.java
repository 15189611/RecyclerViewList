...
import base.visibility.items.ListItemData;
 ...
 *
 * @author Charles       继承Base，滑动事件在这边处理   ----单个RecyclerView的item计算
 */
public class SingleListViewItemActiveCalculator extends BaseItemsVisibilityCalculator {
    ...
    private static final int INACTIVE_LIST_ITEM_VISIBILITY_PERCENTS = 70;  //大于百分之70 可见度
     ...
     *
     * @param itemsPositionGetter    快速滑动和滑动 处理的方法    ItemsPositionGetter
     */
    @Override
     ...
     * @param lastVisiblePosition       计算最大显示的item
     */
